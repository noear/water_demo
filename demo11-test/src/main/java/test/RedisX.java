 ...
 public class RedisX {
    ...
    public RedisX(Properties prop) {
        ...
        initDo(server,
                ...
                password,
                Integer.parseInt(db),
                (isEmpty(maxTotaol) ? 200 : Integer.parseInt(maxTotaol))
        );
    }
    ...
    public RedisX(String server, int db) {
        initDo(server, null, null, db, 200);
    }

    public RedisX(String server, String password, int db) {
        initDo(server, null, password, db, 200);
    }
